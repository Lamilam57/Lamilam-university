...
if (isset($_POST['submit'])) {
    ...
    if (empty(isset($_POST['code']))) {
        ...
        header("Location: ../course_registration_2.php?id=$id&semester=$semester");
        exit();
    } else {
        ...
        /* echo $code;
            ...
            echo $session;
            echo "<br>"; */
            if (empty($level) || empty($matric_no) || empty($value)  || empty($d_title) || empty($session) || empty($code) || empty($unit)) {
                $_SESSION['fields'] = '<div class="error text-center">Fill all fields</div>';
                header("Location: ../course_registration_2.php?id=$id&semester=$semester");
                exit();
            }
    ...
    header("Location: ../course_registration_2.php?id=$id");
    exit();
}
